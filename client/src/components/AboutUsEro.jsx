...
const AboutUsEro = () => {
  ...
  return (
    <main className="flex flex-col max-md:gap-20 md:flex-row pb-20 items-center justify-between mt-40 px-4 md:px-16 lg:px-24 xl:px-32">
...
<p className="text-center md:text-left text-sm text-slate-700 max-w-lg mt-2">
    Discover the perfect rental, book effortlessly, and enjoy your getaway with confidence. Our team is here to help you every step of the way.
          ...
          >
                  ...
                  <a href="mailto:medaiconsulting17@gmail.com" className="flex items-center gap-2 border border-slate-600 active:scale-95 hover:bg-white/10 transition text-slate-600 rounded-md px-6 h-11">
